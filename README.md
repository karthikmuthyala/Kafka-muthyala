...
```PowerShell
java -cp .\target\Kafka-muthyala-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.karthik.CustomConsumer
```
...
```PowerShell
java -cp .\target\Kafka-muthyala-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.karthik.CustomProducer
```
